...
export default function MostPopular() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <Helmet>
        <title>Most Popular - KIDS STORY HUB</title>
      </Helmet>

      <div className="mb-12">
        <h1 className="text-3xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-red-500 mb-4 flex items-center gap-4">
          <Star className="w-10 h-10 text-amber-500" />
          Most Popular
        </h1>
        <p className="text-xl text-slate-600 dark:text-slate-400 font-medium">
          The most loved and read stories by everyone!
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-24 bg-white dark:bg-slate-800/50 rounded-3xl border-2 border-dashed border-violet-100 dark:border-slate-700">
          ...
          <p className="text-slate-500 max-w-md mx-auto">Check back later.</p>
        </div>
      )}
